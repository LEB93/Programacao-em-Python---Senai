# O for é uma estrutura de repetição usada para executar um bloco de código várias vezes, percorrendo uma sequência de valores, como uma lista, uma string ou um intervalo numérico (range).
# É um, loop finito, depende do range determinado.
#for variável in sequência:
    # bloco de código a ser repetido

# WIndows + ponto (.) para jogar emojis
